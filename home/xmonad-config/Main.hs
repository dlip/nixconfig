      ...
      docks $
        ewmh
          ...
          `additionalKeysP` [ ("M-r", windows W.focusUp),
                              ...
                              ("M-.", spawn "emoji-menu"),
                              ("M-w", spawn "rofi -show-icons -modi windowcd -show windowcd"),
                              ("M-S-w", spawn "rofi -show-icons -modi window -show window"),
                              ("M-p", spawn "rofi -show-icons -show combi -combi-modi 'drun,run' -modi combi"),
