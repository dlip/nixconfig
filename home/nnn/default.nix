{
  ...
  nnn = pkgs.writeShellScriptBin "nnn" ''
    export NNN_PLUG='f:finder;o:fzopen;p:mocplay;d:diffs;m:nmount;v:imgview;r:renamer;c:.cbcp;s:-!echo $PWD/$nnn|xclip -sel c*;h:-!hx $nnn*;t:-!helix-open "$PWD/$nnn"*;w:!nnn-cwd*;b:-!nnn-git-blame'
