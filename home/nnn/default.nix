{
  ...
  nnn = pkgs.writeShellScriptBin "nnn" ''
    export NNN_PLUG='f:finder;o:fzopen;p:mocplay;d:diffs;m:nmount;v:imgview;r:renamer;c:.cbcp;s:-!echo $PWD/$nnn|xclip -sel c*;h:-!hx $nnn*;t:-!~/code/nixconfig/scripts/helix-open $PWD/$nnn*;w:!~/code/nixconfig/scripts/nnn-cwd*'
