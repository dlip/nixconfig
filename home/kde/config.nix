{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-50d1ef1f-49b3-4adf-8618-8243a517c9ef" = [ ];
      "ActivityManager"."switch-to-activity-aad297cc-b62a-4ec1-b451-7e57d743f2e5" = [ ];
      ...
      "bismuth"."focus_next_window" = "Meta+Right";
      "bismuth"."focus_prev_window" = "Meta+Left";
      ...
      "kwin"."Switch One Desktop to the Left" = "Meta+Up";
      "kwin"."Switch One Desktop to the Right" = "Meta+Down";
      ...
      "org_kde_powerdevil"."Sleep" = ["Meta+Shift+S" "Sleep"];
      ...
      "plasmawindowed"."show-on-mouse-pos" = "Meta+V";
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."50d1ef1f-49b3-4adf-8618-8243a517c9ef" = "Default";
      "kactivitymanagerdrc"."activities"."aad297cc-b62a-4ec1-b451-7e57d743f2e5" = "Default";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP-1=1;HDMI-1=1;DP-1=1;DP-2=1;";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{02632d8a-a98e-4453-8d94-a02ca7733a13}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{349e65d2-4421-4804-b267-da2d56949c7c}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{c25896ec-6608-472e-9172-39a582b20046}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{940188dd-65f6-47da-9d03-08fccda751a8}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{368f1699-d517-43e7-b196-b2877b0ba671}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{57677022-5554-46b7-9c50-cdb36aa296c8}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{44cc2a4f-b54a-4a7a-8714-d7b6129443a3}";
      ...
      "kwinrc"."Desktops"."Id_3" = "d5f46282-0cc5-4d47-b4fc-200cc15e53c5";
      "kwinrc"."Desktops"."Id_4" = "433dfb30-8359-4cfd-bc8c-9de5d758c636";
      "kwinrc"."Desktops"."Id_5" = "0bd3bcce-62ca-4d40-9867-1edbf63405b6";
      "kwinrc"."Desktops"."Id_6" = "4369ca1b-9f03-456f-9652-c81677c4c9de";
      "kwinrc"."Desktops"."Id_7" = "01fd5f67-b650-4f58-bac7-553f3736f5c7";
      "kwinrc"."Desktops"."Id_8" = "e047c0db-75d1-4f94-b5c3-61c728bc3efa";
      ...
      "kwinrc"."Tiling.59fb5748-f2ed-5bcc-b29e-a4122bb16613"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrulesrc"."1"."wmclass" = "slack";
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."2"."Description" = "Application settings for kitty";
      "kwinrulesrc"."2"."clientmachine" = "localhost";
      "kwinrulesrc"."2"."desktops" = "0bd3bcce-62ca-4d40-9867-1edbf63405b6";
      "kwinrulesrc"."2"."desktopsrule" = 2;
      "kwinrulesrc"."2"."wmclass" = "kitty";
      "kwinrulesrc"."2"."wmclassmatch" = 1;
      "kwinrulesrc"."3"."Description" = "Application settings for google-chrome";
      "kwinrulesrc"."3"."clientmachine" = "localhost";
      "kwinrulesrc"."3"."desktops" = "433dfb30-8359-4cfd-bc8c-9de5d758c636";
      "kwinrulesrc"."3"."desktopsrule" = 3;
      "kwinrulesrc"."3"."wmclass" = "google-chrome";
      "kwinrulesrc"."3"."wmclassmatch" = 1;
      "kwinrulesrc"."3c6c650d-e472-4661-bf15-b16788724b3c"."Description" = "Application settings for alacritty";
      "kwinrulesrc"."3c6c650d-e472-4661-bf15-b16788724b3c"."clientmachine" = "localhost";
      "kwinrulesrc"."3c6c650d-e472-4661-bf15-b16788724b3c"."desktops" = "0bd3bcce-62ca-4d40-9867-1edbf63405b6";
      "kwinrulesrc"."3c6c650d-e472-4661-bf15-b16788724b3c"."desktopsrule" = 2;
      "kwinrulesrc"."3c6c650d-e472-4661-bf15-b16788724b3c"."wmclass" = "alacritty";
      "kwinrulesrc"."3c6c650d-e472-4661-bf15-b16788724b3c"."wmclassmatch" = 1;
      "kwinrulesrc"."3f123a9e-4c06-454f-b8a3-c0061e0dc469"."Description" = "Application settings for systemmonitor";
      "kwinrulesrc"."3f123a9e-4c06-454f-b8a3-c0061e0dc469"."clientmachine" = "localhost";
      ...
      "kwinrulesrc"."5"."Description" = "Application settings for obsidian";
      "kwinrulesrc"."5"."desktops" = "4369ca1b-9f03-456f-9652-c81677c4c9de";
      "kwinrulesrc"."5"."desktopsrule" = 3;
      "kwinrulesrc"."5"."wmclass" = "obsidian";
      "kwinrulesrc"."5"."wmclassmatch" = 1;
      "kwinrulesrc"."5bd38170-b8a2-46e4-bb1f-025c7d5736b4"."Description" = "Application settings for dolphin";
      ...
      "kwinrulesrc"."79b439b4-741b-4fab-92fa-0aec0a62a487"."desktopsrule" = 2;
      "kwinrulesrc"."79b439b4-741b-4fab-92fa-0aec0a62a487"."wmclass" = "alacritty";
      "kwinrulesrc"."79b439b4-741b-4fab-92fa-0aec0a62a487"."wmclassmatch" = 1;
      "kwinrulesrc"."85f0fd55-79ac-445e-ba1e-edef6ce9a708"."Description" = "Application settings for kitty";
      "kwinrulesrc"."85f0fd55-79ac-445e-ba1e-edef6ce9a708"."clientmachine" = "localhost";
      "kwinrulesrc"."85f0fd55-79ac-445e-ba1e-edef6ce9a708"."desktops" = "0bd3bcce-62ca-4d40-9867-1edbf63405b6";
      "kwinrulesrc"."85f0fd55-79ac-445e-ba1e-edef6ce9a708"."desktopsrule" = 3;
      "kwinrulesrc"."85f0fd55-79ac-445e-ba1e-edef6ce9a708"."wmclass" = "kitty";
      "kwinrulesrc"."85f0fd55-79ac-445e-ba1e-edef6ce9a708"."wmclassmatch" = 1;
      "kwinrulesrc"."8852c6ea-4957-43bc-a0ae-e0f9238aa4a6"."Description" = "Application settings for teams";
      "kwinrulesrc"."8852c6ea-4957-43bc-a0ae-e0f9238aa4a6"."desktops" = "f115a74a-d615-4c76-81e4-379f8183876c";
      ...
      "kwinrulesrc"."General"."rules" = "1,2,b53d3193-5a7f-44d6-9562-0f9c36f3bb8f,3,4,5";
      "kwinrulesrc"."b53d3193-5a7f-44d6-9562-0f9c36f3bb8f"."Description" = "Application settings for alacritty";
      "kwinrulesrc"."b53d3193-5a7f-44d6-9562-0f9c36f3bb8f"."clientmachine" = "localhost";
      ...
      "kwinrulesrc"."d6baacc1-0a9e-4d4d-9e7a-44382997495c"."desktopsrule" = 3;
      "kwinrulesrc"."d6baacc1-0a9e-4d4d-9e7a-44382997495c"."wmclass" = "slack";
      "kwinrulesrc"."d6baacc1-0a9e-4d4d-9e7a-44382997495c"."wmclassmatch" = 1;
      "kwinrulesrc"."fd512bb7-f8b3-4420-b5b8-36c70e653aab"."Description" = "Application settings for google-chrome";
      "kwinrulesrc"."fd512bb7-f8b3-4420-b5b8-36c70e653aab"."clientmachine" = "localhost";
      "kwinrulesrc"."fd512bb7-f8b3-4420-b5b8-36c70e653aab"."desktops" = "433dfb30-8359-4cfd-bc8c-9de5d758c636";
      "kwinrulesrc"."fd512bb7-f8b3-4420-b5b8-36c70e653aab"."desktopsrule" = 3;
      "kwinrulesrc"."fd512bb7-f8b3-4420-b5b8-36c70e653aab"."wmclass" = "google-chrome";
      "kwinrulesrc"."fd512bb7-f8b3-4420-b5b8-36c70e653aab"."wmclassmatch" = 1;
