{
  programs.plasma = {
    ...
    files = {
      ...
      "kwinrulesrc"."1"."Description" = "Application settings for google-chrome";
      "kwinrulesrc"."1"."clientmachine" = "localhost";
      "kwinrulesrc"."1"."desktops" = "433dfb30-8359-4cfd-bc8c-9de5d758c636";
      "kwinrulesrc"."1"."desktopsrule" = 3;
      "kwinrulesrc"."1"."wmclass" = "google-chrome";
      ...
      "kwinrulesrc"."General"."rules" = "85f0fd55-79ac-445e-ba1e-edef6ce9a708,1";
      ...
      "systemsettingsrc"."Open-with settings"."History" = "fire";
