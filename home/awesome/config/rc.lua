...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mywibox:setup({
    ...
    {             -- Right widgets
      ...
      logout_menu_widget({
        onlock = function()
          awful.spawn.with_shell("lock-screen")
        end,
      }),
    },
  })
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey }, "l", function()
    awful.util.spawn_with_shell("lock-screen")
  end, { description = "Lock screen", group = "awesome" }),
  awful.key({ modkey, "Shift" }, "s", function()
    awful.util.spawn_with_shell("systemctl suspend")
  end, { description = "Suspend", group = "awesome" }),
  awful.key({ modkey, "Shift" }, ";", function()
    awful.util.spawn_with_shell("launch-default-programs")
  end, { description = "Launch default programs", group = "launcher" }),
  awful.key({ modkey }, ".", function()
    awful.util.spawn_with_shell("emoji-menu")
  end, { description = "Emoji menu", group = "launcher" }),
  awful.key({ modkey }, "c", function()
    awful.util.spawn_with_shell("CM_LAUNCHER=rofi clipmenu")
  end, { description = "Clip menu", group = "launcher" }),
  awful.key({ modkey, "Shift" }, "f", function()
    awful.util.spawn_with_shell("rofi -show-icons -modi windowcd -show windowcd")
  end, { description = "Select window", group = "launcher" }),
  awful.key({ modkey }, "f", function()
    awful.util.spawn_with_shell("rofi -show-icons -modi window -show window")
  end, { description = "Select window global", group = "launcher" }),
  awful.key({ modkey }, "r", function()
    awful.util.spawn_with_shell("rofi -show-icons -show combi -combi-modi 'drun,run' -modi combi")
  end, { description = "Launch program", group = "launcher" }),
  awful.key({ modkey }, "o", function()
    awful.util.spawn_with_shell("espanso cmd toggle")
  end, { description = "Toggle espanso", group = "launcher" }),
  awful.key({ modkey }, "d", function()
    awful.util.spawn_with_shell("autorandr --change")
  end, { description = "Display change", group = "system" }),
  awful.key({ modkey }, "q", function()
    awful.util.spawn_with_shell("rofi -show power-menu -modi power-menu:power-menu")
...
clientkeys = gears.table.join(
  ...
  awful.key({ modkey }, "a", function(c)
    c.above = not c.above
  end, { description = "toggle keep above", group = "client" }),
  awful.key({ modkey }, "x", function(c)
    local state = not c.floating
    c.floating = state
    c.sticky = state
    c.above = state
  end, { description = "toggle sticky floating above", group = "client" }),
...
awful.rules.rules = {
  ...
  { rule = { class = "Teams" },                   properties = { screen = 1, tag = "2" } },

  { rule = { class = "discord" },                 properties = { screen = 1, tag = "3" } },

  { rule = { class = "Spotify" },                 properties = { screen = 1, tag = "3" } },

  { rule = { class = "Plexamp" },                 properties = { screen = 1, tag = "3" } },

  { rule = { class = "Firefox" },                 properties = { screen = 1, tag = "4" } },

  { rule = { class = "Google-chrome" },           properties = { screen = 1, tag = "4" } },

  { rule = { class = "org.wezfurlong.wezterm" },  properties = { screen = 1, tag = "5" } },

  { rule = { class = "Notes" },                   properties = { screen = 1, tag = "6" } },

  { rule = { class = "obsidian" },                properties = { screen = 1, tag = "6" } },
}
-- }}}
